Orange Moonlight Icon Set, version 1.0
http://dryicons.com/free-icons/preview/orange-moonlight-icons/

Information
----------------------

This icon set contains 50 quality icons in the following formats:
	Transparent ICO
